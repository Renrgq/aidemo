    ...
    <el-card shadow="hover">
      <template #header>
        <div class="card-header">
          <span>系统设置</span>
          <el-button type="primary" icon="Save" @click="handleSaveSettings">
            保存设置
          </el-button>
        </div>
      </template>
      ...
      <el-form :model="form" label-width="150px">
        <el-form-item v-for="setting in settings" :key="setting.id" :label="setting.description">
          <el-input v-model="form[setting.id].value" placeholder="请输入" />
        </el-form-item>
      </el-form>
    </el-card>
  </div>
